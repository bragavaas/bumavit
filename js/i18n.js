...
(function () {
  ...
  var DICT = {
    en: {
      ...
      '.nav__links a[href$="estimador.html"]': 'Estimator',
      '.fab span': 'Let’s talk',
      ...
      '.menu__links a[href$="estimador.html"]': { text: 'Estimator' },
      ...
      '.footer__col a[href$="estimador.html"]': 'Estimator',
    ...
    es: {
      ...
      '.nav__links a[href$="estimador.html"]': 'Estimador',
      '.fab span': 'Hablemos',
      ...
      '.menu__links a[href$="estimador.html"]': { text: 'Estimador' },
